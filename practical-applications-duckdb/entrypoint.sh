...
# 3. Stay alive so the education app and the CLI can share the file.
...
# education app on startup, so running it here too is harmless and lets the CLI
# be useful even before the app starts.
